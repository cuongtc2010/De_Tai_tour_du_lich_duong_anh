...
(function () {
    ...
    CKFinder.DEFAULT_BASEPATH = 'http://localhost:81/admin_cms/uploads';
    ...
    (function () {
        ...
        CKFinder.SetupFCKeditor = function (b, c, d, e) {
            ...
            if (k.substr(0, 1) != '/' && k.indexOf('://') == -1)
                k = document.location.pathname.substring(0, document.location.pathname.lastIndexOf('/') + 1) + k;
            k = f._BuildUrl(k);
            var l = k.indexOf('?') !== -1 ? '&' : '?';
            if (g) {
                k += l + 'configId=' + g;
        ...
        CKFinder.SetupCKEditor = function (b, c, d, e) {
            ...
            if (c !== null && typeof c == 'object') {
                ...
                for (var i in c) {
                    ...
                    if (i == 'Width') {
                        ...
                        var k = g[i] || 600;
                        if (typeof k == 'string' && k.length > 1 && k.substr(k.length - 1, 1) == '%')
            ...
            if (l.substr(0, 1) != '/' && l.indexOf('://') == -1)
                l = document.location.pathname.substring(0, document.location.pathname.lastIndexOf('/') + 1) + l;
            l = g._BuildUrl(l);
            var m = l.indexOf('?') !== -1 ? '&' : '?';
            if (h) {
                l += m + 'configId=' + h;
