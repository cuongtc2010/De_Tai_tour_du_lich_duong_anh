                    ...
                    <table id="myTable" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" >Tên chức vụ</th>
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" >Lương</th>
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" >Phụ cấp</th>
                            ...
                            if (!is_null($list)) {
                                ...
                                foreach ($list as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $i++ ?></td>
                                        <td><a style="color: #2196F3;" href="index.php?ctl=<?= $root_ctl ?>&act=update&id=<?= $value["Id"] ?>" ><?= $value["TenCV"] ?></a></td>
                                        <td class="text-right"><?php echo (number_format($value["MucLuong"])) ?></td>
                                        <td class="text-right"><?php echo (number_format($value["PhuCap"])) ?></td>
                                    </tr>
                                    <?php
                                }
                            }
