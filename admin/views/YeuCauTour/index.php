...
<form name="myform" role="form" method="post" action="<?= ROOT_ADMIN_URL ?>/index.php?ctl=<?= $root_ctl ?>">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Danh sách đặt tour theo yêu cầu</h4>
                    ...
                    <table id="myTable" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 120px;">Số điện thoại</th>                                
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 100px;">Hành trình</th>
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 100px;">Số lượng khách</th>         
                                 <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 120px;">Ngày đi</th> 
                                 <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 120px;">Ngày về</th> 
                            ...
                            if (!is_null($list)) {
                                ...
                                foreach ($list as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $i++ ?></td>
                                        <td><a style="color: #2196F3;" href="#" ><?= $value["TenKH"] ?></a></td>    
                                        <td><?= $value["SDT"] ?></td> 
                                        <td class="text-right"><?php echo $value["HanhTrinh"]    ?></td>
