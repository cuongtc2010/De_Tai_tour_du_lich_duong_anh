                    ...
                    <table id="myTable" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 120px;">Ngày bắt đầu</th>
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 120px;">Ngày kết thúc</th>
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 100px;">Giá</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if (!is_null($list)) {
                                ...
                                foreach ($list as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo (strtotime($value["NgayBatDau"]) > 0) ? date('d/m/Y', strtotime($value["NgayBatDau"])) : ""; ?></td>
                                        <td class="text-right"><?php echo (strtotime($value["NgayKetThuc"]) > 0) ? date('d/m/Y', strtotime($value["NgayKetThuc"])) : ""; ?></td>
                                        <td class="text-right"><?php echo (number_format($value["GiaTien"])) ?></td>
                                    </tr>
                                    <?php
                                }
                            }
