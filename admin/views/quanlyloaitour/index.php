                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="text-center" width="20px">STT</th>
                                 <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 200px;">Tên Tour</th>
                                <th class="text-center sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style="width: 100px;">Mã Tour</th>
                            ...
                            if (!is_null($list)) {
                                ...
                                foreach ($list as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $i++ ?></td>
                                        <td><a style="color: #2196F3;" href="index.php?ctl=<?= $root_ctl ?>&act=update&id=<?= $value["Id"] ?>" ><?= $value["TenLoai"] ?></a></td>                                                                           
                                        <td class="text-right"><?php echo $value["MaLoai"]    ?></td>
