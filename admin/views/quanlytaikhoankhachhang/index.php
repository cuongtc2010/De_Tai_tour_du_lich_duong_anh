...
<!--                        <center>
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" >Tên khách hàng</th>
                            ...
                            if (!is_null($list)) {
                                ...
                                foreach ($list as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $i++ ?></td>
                                        <td><a style="color: #2196F3;" href="index.php?ctl=<?= $root_ctl ?>&act=update&id=<?= $value["Id"] ?><?= !empty($value["KHId"]) ? "&KHId={$value["KHId"]}" : "" ?>" ><?= $value["TenKH"] ?></a></td>
