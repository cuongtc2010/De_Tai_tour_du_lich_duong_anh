...
$baseUrl = "http://localhost/tourduonganh/admin/uploads/";
...
$folderUpload = isset($_SESSION["folderUpload"]) ? $_SESSION["folderUpload"] : "Images";
if ($folderUpload == "Images") {
    $config['ResourceType'][] = Array(
        'name' => 'Products',
        'url' => $baseUrl . 'Images',
...
if ($folderUpload == "Posts") {
    $config['ResourceType'][] = Array(
        'name' => 'Post',
        'url' => $baseUrl . 'Post',
        'directory' => $baseDir . 'Post',
        'maxSize' => 0,
        'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
        'deniedExtensions' => '');
}
if ($folderUpload == "Sliders") {
    $config['ResourceType'][] = Array(
        'name' => 'Sliders',
        'url' => $baseUrl . 'Sliders',
        'directory' => $baseDir . 'Sliders',
        'maxSize' => 0,
        'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
        'deniedExtensions' => '');
}
if ($folderUpload == "Video") {
    $config['ResourceType'][] = Array(
        'name' => 'Video',
        'url' => $baseUrl . 'Video',
        'directory' => $baseDir . 'Video',
        'maxSize' => "200M",
        'allowedExtensions' => 'flv,swf,gif,jpeg,jpg,png,mp4',
        'deniedExtensions' => '');
}
if ($folderUpload == "Question") {
    $config['ResourceType'][] = Array(
        'name' => 'Question',
        'url' => $baseUrl . 'Question',
        'directory' => $baseDir . 'Question',
        'maxSize' => "200M",
        'allowedExtensions' => 'flv,swf,gif,jpeg,jpg,png,mp4',
        'deniedExtensions' => '');
}
if ($folderUpload == "Partner") {
    $config['ResourceType'][] = Array(
        'name' => 'Partner',
        'url' => $baseUrl . 'Partner',
        'directory' => $baseDir . 'Partner',
        'maxSize' => "200M",
        'allowedExtensions' => 'flv,swf,gif,jpeg,jpg,png,mp4',
        'deniedExtensions' => '');
}
if ($folderUpload == "Album") {
    $config['ResourceType'][] = Array(
        'name' => 'Album',
        'url' => $baseUrl . 'Album',
        'directory' => $baseDir . 'Album',
        'maxSize' => "200M",
        'allowedExtensions' => 'gif,jpeg,jpg,png',
        'deniedExtensions' => '');
}
if ($folderUpload == "Logo") {
    $config['ResourceType'][] = Array(
        'name' => 'Logo',
        'url' => $baseUrl . 'Logo',
...
if ($folderUpload == "Doctors") {
    $config['ResourceType'][] = Array(
        'name' => 'Doctors',
        'url' => $baseUrl . 'Doctors',
        'directory' => $baseDir . 'Doctors',
        'maxSize' => "200M",
        'allowedExtensions' => 'gif,jpeg,jpg,png',
        'deniedExtensions' => '');
}
if ($folderUpload == "Speciality") {
    $config['ResourceType'][] = Array(
        'name' => 'Speciality',
        'url' => $baseUrl . 'Speciality',
        'directory' => $baseDir . 'Speciality',
        'maxSize' => "200M",
        'allowedExtensions' => 'gif,jpeg,jpg,png',
        'deniedExtensions' => '');
}
/*
  ...
  $config['ResourceType'][] = Array(
  'name' => 'Slideshow',
  'url' => $baseUrl . 'slideshow',
  'directory' => $baseDir . 'slideshow',
  'maxSize' => 0,
  'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
  'deniedExtensions' => '');
...
//    'directory' => $baseDir . 'video',
//    'maxSize' => "200M",
//    'allowedExtensions' => 'flv,swf,gif,jpeg,jpg,png',
//    'deniedExtensions' => '');
